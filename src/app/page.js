  ...
  return (
    <div className="p-6">
      ...
      <div className="flex justify-center gap-4 mb-6">
        <button
          className={`px-4 py-2 rounded-lg border ${platform === 'Instagram' ? 'bg-black text-white' : ''}`}
          onClick={() => setPlatform('Instagram')}
        >
          Instagram
        </button>
        <button
          className={`px-4 py-2 rounded-lg border ${platform === 'Twitter' ? 'bg-black text-white' : ''}`}
